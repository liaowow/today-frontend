    ...
    if (entryCount === 0) {
        ...
        switch(maxIndex) {
            case 0:
                ...
                emojiDisplayDiv.innerHTML = `<img class="emoji-display" src="https://liaowow.github.io/today-frontend/img/emoji-happy.png">
            ...
            case 1:
                ...
                emojiDisplayDiv.innerHTML = `<img class="emoji-display" src="https://liaowow.github.io/today-frontend/img/emoji-sad.png">
                <h6>(Sad)</h6>
                <br>`
            ...
            case 2:
                ...
                emojiDisplayDiv.innerHTML = `<img class="emoji-display" src="https://liaowow.github.io/today-frontend/img/emoji-angry.png">
                <h6>(Angry)</h6>
                <br>`
            ...
            case 3:
                ...
                emojiDisplayDiv.innerHTML = `<img class="emoji-display" src="https://liaowow.github.io/today-frontend/img/emoji-calm.png">
